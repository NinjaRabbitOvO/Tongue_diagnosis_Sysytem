...
def main():
    ...
    train_dir = os.path.join(image_path, "train3_intented")
    validation_dir = os.path.join(image_path, "val3_intented")
    ...
    with open('class_indices_intented.json', 'w') as json_file:
    ...
    for epoch in range(epochs):
        ...
        if val_loss.result() < best_test_loss:
            ...
            model.save_weights("./save_weights_intented/resNet_50.ckpt", save_format="tf")
