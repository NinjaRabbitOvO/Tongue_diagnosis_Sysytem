...
def main():
    ...
    train_dir = os.path.join(image_path, "train1_crack")
    validation_dir = os.path.join(image_path, "val1_crack")
    ...
    with open('class_indices_crack.json', 'w') as json_file:
    ...
    for epoch in range(epochs):
        ...
        if val_loss.result() < best_test_loss:
            ...
            model.save_weights("./save_weights_crack/resNet_50.ckpt", save_format="tf")
