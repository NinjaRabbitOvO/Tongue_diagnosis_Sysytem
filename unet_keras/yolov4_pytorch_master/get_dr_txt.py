...
from unet_keras.yolov4_pytorch_master.utils.utils import (DecodeBox, bbox_iou, letterbox_image,
...
class mAP_Yolo(YOLO):
    ...
    def detect_image(self,image_id,image):
        ...
        photo = np.transpose(photo, (2, 0, 1))#transpose()简单来说，就相当于数学中的转置，在矩阵中，转置就是把行与列相互调换位置；
        #---------------------------------------------------------#
        #   添加上batch_size维度
        #---------------------------------------------------------#
        images = [photo]
